...
1.การรับเงินจากหลายบัญชีในช่วงเวลาสั้น (high fan-in)

2.การโอนเงินถี่ผิดปกติ (high transaction velocity)

3.การมีธุรกรรมที่เบี่ยงเบนจากพฤติกรรมปกติ (abnormal deviation)
